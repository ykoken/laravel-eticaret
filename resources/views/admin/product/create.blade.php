        ...
        <div class="admin-form theme-primary">
            ...
            <div id="p1" class="panel heading-border panel-primary">
                ...
                <div class="panel-body bg-light">
                    <form action="#" id="addProductForm" name="addProductForm" method="post"
                          enctype="multipart/form-data">
                        <div class="section-divider mb40" id="spy1">
                            <span>Ürün Oluşturma Formu</span>
                        </div>
                        <!-- .section-divider -->
                    {{csrf_field()}}
                    ...
                    <!-- Multi Selects -->
                        <div class="row">
                            <div class="col-md-4">
                                <div class="section">
                                    <div class="section"><label for="username" class="field-label">Ürün Adı</label>
                                        <label class="field">
                                            <input type="text" name="product_name" id="from" class="gui-input"
                            ...
                            <div class="col-md-4">
                                <div class="section">
                                    <div class="section"><label for="username" class="field-label">Ürün Kodu</label>
                                        <label class="field">
                                            <input type="text" name="product_code" id="from" class="gui-input"
                              ...
                              <div class="col-md-2">
                                <div class="section"><label for="username" class="field-label">Ücreti</label>
                                    <label class="field">
                                        <input type="text" name="price"   class="gui-input sayikontrol"
                            ...
                            <div class="col-md-2">
                                <div class="section"><label for="stock" class="field-label">Stok Ekle</label>
                                    <label class="field">
                                        <input type="text" name="stock" id="from" class="gui-input sayikontrol"
                                               placeholder="0">
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section"><label for="urun_resim" class="field-label">Ürün Resmi
                                        Ekle</label>
                                    <label class="field">
                                        <input type="file" name="product_image" class="gui-input">
                                    </label>
                                    <em for="newproduct_image" class="field prepend-icon state-error"
                                        style="color: red;"></em>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-footer text-right">
                            <button type="submit" class="button btn-primary">Ürün Ekle</button>
